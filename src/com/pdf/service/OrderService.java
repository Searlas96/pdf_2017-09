...
//	int UpdateOrder(String order_id, String schedule,String user_id);
	 ...
	 * 函数功能:更新读过了订单
	 * @author Searlas
	 * 时间2017年10月13日上午10:45:04
	 * @param order_id
	 * @param user_id
	 * @return
	 */
	int readOrder(String order_id, String user_id);
	/**
	 * 
	 * 函数功能:编辑订单基础信息
	 * @author Searlas
	 * 时间2017年10月13日上午11:17:17
	 * @param file
	 * @return
	 */
	int editOrder(File file);
	/**
	 * 
	 * 函数功能:获取待处理订单
	 * @author Searlas
	 * 时间2017年10月13日下午12:50:44
	 * @param user_id
	 * @param role_id
	 * @return
	 */
	List<File> getWorkOrderList(String user_id, String role_id);
	/**
	 * 
	 * 函数功能:根据订单名称搜索订单 精确
	 * @author Searlas
	 * 时间2017年10月16日下午2:49:41
	 * @param order_name
	 * @return
	 */
	File searchOrderByName(String order_name);
