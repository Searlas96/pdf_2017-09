...
public class UserDaoImpl implements UserDao{
	...
	public int AddUser(User user) {
		...
		String sql2 = "select user_id from user where user.account = "+account +" and user.user_state =1";
	...
	public boolean DeleteUser(String user_id) {
		String sql = "delete from user where user.user_id = "+user_id;
		int result = 0;
		try {
			System.out.println(sql);
	...
	public boolean DeleteUserList(String user_list) {
		String sql = "delete from user where user.user_id in ("+user_list+")";
		int result = 0 ;
		try {
			System.out.println(sql);
			result = runerQuery.update(sql);
