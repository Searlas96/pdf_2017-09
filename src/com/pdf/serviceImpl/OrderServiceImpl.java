...
public class OrderServiceImpl implements OrderService {
	...
	public int readOrder(String order_id, String user_id) {
		return daoInstance.readOrder(order_id,user_id);
	}


	@Override
	public int editOrder(File file) {
		return daoInstance.editOrder(file);
	}


	@Override
	public List<File> getWorkOrderList(String user_id, String role_id) {
		return daoInstance.getWorkOrderList(user_id,role_id);
	}


	@Override
	public File searchOrderByName(String order_name) {
		return daoInstance.searchOrderByName(order_name);
	}
